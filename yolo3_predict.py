...
class YOLO(object):
    def __init__(self):
        ...
        self.model_path = 'logs/000/trained_weights_100.h5'  # 模型文件
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            #label = '{} '.format(predicted_class)  # 标签
...
def detect_img_for_test():
    yolo = YOLO()
    img_path = '/Users/wangzizhe/Desktop/final_pro/code/data/139.jpg'
    image = Image.open(img_path)
...
def test_of_detect_objects_of_image():
    yolo = YOLO()
    img_path = '/Users/wangzizhe/Desktop/final_pro/code/data/14.jpg'
